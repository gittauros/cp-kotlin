...
import com.tauros.cp.structure.LazySegmentTreeNode
...
//    }
    ...
    class Info(cl: int, cr: int) : LazySegmentTreeNode<Info, boolean>(cl, cr) {
        var c00: int = 0
        var c11: int = 0
        var c01: int = 0
        var c10: int = 0
    ...
    val seg = LazySegmentTree(0, n - 1) { cl, cr -> Info(cl, cr) }
//    println(buildString {
